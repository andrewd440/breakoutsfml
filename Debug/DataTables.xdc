...
<member name="M:spawnLevelOne" decl="false" source="d:\users\andrew\perforceworkspace\drew-deskpc\drewski's block breaker\drewski's block breaker\datatables.cpp" line="14">
<summary>
Creates the brick set of level one.
</summary>
<returns>Vector of unique pointers to bricks</returns>
</member>
<member name="M:spawnLevelTwo" decl="false" source="d:\users\andrew\perforceworkspace\drew-deskpc\drewski's block breaker\drewski's block breaker\datatables.cpp" line="45">
<summary>
Creates the brick set of level two.
</summary>
<returns>Vector of unique pointers to bricks</returns>
</member>
<member name="M:spawnLevelThree" decl="false" source="d:\users\andrew\perforceworkspace\drew-deskpc\drewski's block breaker\drewski's block breaker\datatables.cpp" line="74">
<summary>
Creates the brick set of level three.
</summary>
<returns>Vector of unique pointers to bricks</returns>
</member>
<member name="M:initializeBrickTable" decl="false" source="d:\users\andrew\perforceworkspace\drew-deskpc\drewski's block breaker\drewski's block breaker\datatables.cpp" line="103">
<summary>
Initializes a table for info on each type of brick.
</summary>
<returns>Vector indexed by Brick::Type</returns>
</member>
<member name="M:initializeLevelTable" decl="false" source="d:\users\andrew\perforceworkspace\drew-deskpc\drewski's block breaker\drewski's block breaker\datatables.cpp" line="126">
<summary>
Initializes a table for info on each level.
</summary>
<returns>Vector indexed by Level::ID</returns>
</member>
<member name="M:initializeParticleTable" decl="false" source="d:\users\andrew\perforceworkspace\drew-deskpc\drewski's block breaker\drewski's block breaker\datatables.cpp" line="146">
<summary>
